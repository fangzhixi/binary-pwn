...
def x_man_level3(file_name='/mnt/hgfs/Cyber Security PWN/jarvisoj/level3/[XMAN]level3'):
    print('[XMAN]level3 start')
    target = process([file_name])
    target = remote('pwn2.jarvisoj.com', 9879)
    target_elf = ELF(file_name)
    libc_elf = ELF('/mnt/hgfs/Cyber Security PWN/jarvisoj/level3/libc-2.19.so')
